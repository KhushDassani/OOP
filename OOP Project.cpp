...
class passenger
{
	...
	void getdata()
	{
		...
		cin>>busi_fare;
		cout<<"Enter first class fare:-"<<endl;
		cin>>first_fare;
	...
	cout<<"First class fare is:-"<<first_fare;
...
class first_class:public passenger
{

};
int main()
{
	if (pas_class==economy)
	{
	eco_class e;
	e.getdata();
	...
	else if (pas_class==first)
	{
	first_class f;
	f.getdata();
	cout<<"\nDetails of first class passengers\n";
	f.display();
	}
	else 
	return -1;
